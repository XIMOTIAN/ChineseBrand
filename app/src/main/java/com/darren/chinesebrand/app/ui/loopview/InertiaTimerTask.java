...
final class InertiaTimerTask implements Runnable {
    ...
    public final void run() {
        ...
        if (!loopView.isLoop) {
            ...
            } else if (loopView.totalScrollY >= (int) ((float) (loopView.mAdapter.getCount() - 1 - loopView.initPosition) * itemHeight)) {
                loopView.totalScrollY = (int) ((float) (loopView.mAdapter.getCount() - 1 - loopView.initPosition) * itemHeight);
                a = -40F;
            }
        }
        if (a < 0.0F) {
