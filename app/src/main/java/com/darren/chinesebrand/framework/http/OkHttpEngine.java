...
import com.darren.chinesebrand.base.http.IHttpEngine;
...
public class OkHttpEngine implements IHttpEngine {
    ...
    public void post(final boolean cache, Context context, String url, Map<String, Object> params, final EngineCallback callBack) {
        ...
        if (cache) {
            final String cacheJson = IOHandlerFactory.getDefaultIOHandler().getString(finalUrl);
        ...
        mOkHttpClient.newCall(request).enqueue(
                new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        LogUtils.json("Post Response", resultJson);
                        if (cache) {
                            final String cacheJson = IOHandlerFactory.getDefaultIOHandler().getString(finalUrl);
                        ...
                        IOHandlerFactory.getDefaultIOHandler().save(finalUrl,resultJson);
                    }
                }
        );
    }
