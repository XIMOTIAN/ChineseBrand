...
/**
 * description:
 * author: Darren on 2017/11/14 15:53
...
public class BannerView extends RelativeLayout {
    ...
    private TextView mDotIndicatorTv;
    ...
    private void initView() {
        ...
        mDotIndicatorTv = (TextView) findViewById(R.id.dot_container);
    ...
    private void pageSelect(int position) {
        ...
        mDotIndicatorTv.setText(GeneralUtil.fromHtml("<font color='#E84040'>" + (mCurrentPosition + 1)
                + "</font><font color='#FFFFFF'>/" + mAdapter.getCount() + "</font>"));
        // 6.3设置广告描述
    ...
    private void initDotIndicator() {
        ...
        mDotIndicatorTv.setText(GeneralUtil.fromHtml("<font color='#E84040'>1</font><font color='#FFFFFF'>/" + count + "</font>"));
    }
